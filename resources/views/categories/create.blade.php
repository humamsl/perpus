...
@include('partials.page-header', [
    ...
    'desc'  => 'Tambahkan kategori buku baru.',
    'actions' => [
        ['url' => route('categories.index'), 'label' => 'Kembali', 'class' => 'btn-secondary', 'icon' => 'fa-arrow-left'],
    ],
])

<form method="POST" action="{{ route('categories.store') }}" class="card grid grid-cols-1 md:grid-cols-2 gap-4">@csrf
    <div>
    ...
    <div>
        ...
        <input name="dewey_code" class="form-input mt-1">
    </div>
