<?php $__env->startSection('title','Tambah Rak'); ?>
<?php $__env->startSection('content'); ?>
<h1 class="text-2xl font-bold mb-4">Tambah Rak</h1>
<form method="POST" action="<?php echo e(route('shelves.store')); ?>" class="card grid md:grid-cols-2 gap-3"><?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Aplikasi Perpus\digital-library\resources\views/shelves/create.blade.php ENDPATH**/ ?>