...
<section class="mb-10" x-data="{
    ...
    <div x-ref="track" @scroll.debounce.100ms="onScroll"
        ...
        <div class="snap-start shrink-0 w-52 md:w-56 rounded-2xl p-5 flex flex-col justify-between text-white bg-gradient-to-br <?php echo e($accentClasses['tile']); ?>">
            <div>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <?php endif; ?>
                <div class="card-tight h-full flex flex-col hover:shadow-hover transition group-hover:-translate-y-1">
                    <div class="aspect-[3/4] rounded-lg mb-3 overflow-hidden relative bg-gradient-to-br <?php echo e($accentClasses['cover']); ?>">
                        <?php if($book->cover): ?>
                            <img src="<?php echo e(asset('storage/'.$book->cover)); ?>" class="w-full h-full object-cover" loading="lazy">
                        <?php else: ?>
                            <div class="absolute inset-0 flex items-center justify-center <?php echo e($accentClasses['icon']); ?>">
    ...
    <div class="flex justify-center gap-1.5 mt-3">
        <?php for($i = 0; $i < 3; $i++): ?>
            <button type="button" @click="goTo(<?php echo e($i); ?>)"
                    ...
                    :class="active === <?php echo e($i); ?> ? 'w-6 <?php echo e($accentClasses['dot']); ?>' : 'w-1.5 bg-slate-300'"></button>
        <?php endfor; ?>
    </div>
</section>
